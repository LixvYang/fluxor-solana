...
use crate::{
    events::ContentPublished, Article, ArticlePrivateContent, FluxorError, ARTICLE_DISABLED,
    ARTICLE_SEED, CONTENT_SEED, MAX_CONTENT_BYTES,
};

#[derive(Accounts)]
pub struct PublishPrivateContent<'info> {
    #[account(
...
pub fn handler(
    ...
    content.content_version = next_version;
